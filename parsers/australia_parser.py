...
# ============================================================================
class AustraliaHybridParser(DefaultTextParser):
    """Australia 문서: 텍스트 파서 먼저 → 실패 시 Vision 폴백"""

    def __init__(self, client):
        super().__init__(client)
        self._vision = AustraliaVisionParser(client)
...
# 기본적으로 하이브리드 버전 사용
AustraliaParser = AustraliaHybridParser
